...
0. 엔트로피는 정보 환경에서 발생하지 않아야 한다 (무효법, null law)
1. 엔트로피가 정보 환경에서 발생하지 않도록 막아야 한다
2. 엔트로피는 정보 환경에서 제거되어야 한다
3. 정보의 복지(welfare)는 정보 환경의 (정보량의) 확장, (정보 품질의) 개선 및 (정보 다양성의) 풍부화를 통해 추진되어야 한다
